...
set(handles.xText, 'string', sprintf('%.2f', handles.simulationObj.walls(handles.currentWallId, 1) + xyDiff(1)));
set(handles.yText, 'string', sprintf('%.2f', handles.simulationObj.walls(handles.currentWallId, 2) + xyDiff(2)));
